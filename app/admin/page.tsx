                ...
                <TableRow key={product.id} className="hover:bg-gray-50">
                  <TableCell>
                    {product.image ? (
                      ...
                      <div className="w-[60px] h-[60px] bg-gray-100 rounded flex items-center justify-center text-xs text-gray-400 border">
                        No Img
                      </div>
                    )}
                  </TableCell>
...
function LaporanContent() {
  return (
    <div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Penjualan per Kategori (Bulan Ini)</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <p className="mt-4 text-sm text-gray-500">
        Data laporan masih menggunakan data palsu. API belum dibuat.
      </p>
    </div>
  );
}
...
function NavItem({
  ...
  return (
    ...
    >
      {" "}
      {icon} {open && <span className="truncate">{label}</span>}{" "}
    </button>
  );
}
          ...
          <>
            ...
            <section className="bg-white shadow-md rounded-xl p-6">
              ...
              <p className="text-gray-500">
                Grafik atau data ringkasan akan muncul di sini.
              </p>
            </section>
          </>
        );
