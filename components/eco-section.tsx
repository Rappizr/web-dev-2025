  ...
  <section className="py-12 lg:py-20" data-aos="fade-up">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div
          ...
          style={{
            backgroundImage: 'url(/images/home-category/cta.jpg)',
        ...
        >
          ...
          <div className="flex flex-col gap-6 sm:gap-0 sm:flex-row items-center justify-between w-full relative z-10">
            ...
            <Link href="/register" className="" data-aos="fade-left">
              <Button
                size="lg"
                className="bg-white/80 text-primary font-bold text-lg px-12 py-7 rounded-2xl shadow-xl hover:bg-white hover:scale-105 hover:shadow-2xl transition-all duration-300"
              >
                Daftar Sekarang
              </Button>
            </Link>
